...
int main(int argc, char** argv){
    ...
    */
    ...
    AbstractQueue* q1 = top->change_queue_s_uplink(0, nullptr, true, threshp, "oq1.csv");
    AbstractQueue* q2 = top->change_queue_s_downlink(127, nullptr, true, threshp, "oq2.csv");
    ...
    mtpSrc = new MtpSrcOg(NULL, NULL, eventlist, speedFromMbps((double)HOST_NIC), "mtpogsrc.csv");
