...
class AbstractQueue : public EventSource, public PacketSink{
    public:
        AbstractQueue(linkspeed_bps bitrate, mem_b maxsize, EventList &eventlist, 
	        AbstractQueueLogger* logger);
        ...
        virtual void setLogger(AbstractQueueLogger* logger) {
            _logger = logger;
        }
