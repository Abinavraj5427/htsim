...
/**
 * Deletes previous packet sent times since 
 * cummulative ack acknowledges all prior
 * sent times
*/
void 
...
/**
 * Determines which packets need to be restransmitted
 * based on prior send times. Deletes from _sent_times
 * to avoid duplicate packets sent too close to each other.
*/
void 
